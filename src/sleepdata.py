...
class Average_Gyro_Data():
    ...
    def process(self, gyro_data):
        gyro_movement = [0, 0, 0, 0]
        for gyro_datum in gyro_data:
            gyro_delta_x = gyro_datum['gyro_raw_x'] - self.gyro_last_x
            gyro_delta_x_abs = abs(gyro_datum['gyro_raw_x'] - self.gyro_last_x)
            self.gyro_last_x = gyro_datum['gyro_raw_x']
            
            gyro_delta_y = gyro_datum['gyro_raw_y'] - self.gyro_last_y
            gyro_delta_y_abs = abs(gyro_datum['gyro_raw_y'] - self.gyro_last_y)
            self.gyro_last_y = gyro_datum['gyro_raw_y']

            gyro_delta_z = gyro_datum['gyro_raw_z'] - self.gyro_last_z
            gyro_delta_z_abs = abs(gyro_datum['gyro_raw_z'] - self.gyro_last_z)
