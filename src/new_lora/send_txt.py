...
if __name__ == "__main__" : 
    ...
    print("File id:{}  msg length:{}  delay:{}"\
        .format(file_id, len(lora.sample_message(file_id = file_id, line_id = 0, num_lines = args.num_lines, delay = args.delay, SF = args.spreading_factor)), args.delay)) 
    
    for line in range(args.num_lines) : 
        msg = lora.sample_message(file_id = file_id, line_id = line, num_lines = args.num_lines, delay = args.delay, SF = args.spreading_factor)
